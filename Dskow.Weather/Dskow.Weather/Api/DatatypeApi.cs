...
namespace Dskow.Weather.Api
{
    ...
    public interface IDatatypeApi
    {
        ...
        DatatypeResult FindDatatypes(List<string> datatypeid, List<string> locationid, List<string> stationid, DateTime? startdate, DateTime? enddate, string sortfield, string sortorder, long? limit, long? offset);
        /// <summary>
    ...
    public class DatatypeApi : IDatatypeApi
    {
        ...
        /// <param name="offset">Optional. Defaults to 0, used to offset the resultlist. The example would begin with record 24</param> 
        /// <returns>DatatypeResult</returns>            
        public DatatypeResult FindDatatypes(List<string> datatypeid, List<string> locationid, List<string> stationid, DateTime? startdate, DateTime? enddate, string sortfield, string sortorder, long? limit, long? offset)
        {
